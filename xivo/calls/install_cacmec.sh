...
# getting xivouser
echo "Please type your xivo user"
...
# getting xivosecret
echo "Please type your xivo secret"
...
echo "something like password"
echo "======================="
read -p "type here" GRAPHIP

sed -e "s/graphiteIP/$GRAPHIP/g" conf/calls.py
sed -e "s/graphiteIP/$GRAPHIP/g" conf/dahdi.py
